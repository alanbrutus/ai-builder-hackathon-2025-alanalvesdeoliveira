-- =============================================
-- Script: Corrigir Stored Procedures de Cotação
-- Descrição: Versão simplificada sem joins com tabelas inexistentes
-- =============================================
...
PRINT '✓ AIHT_sp_ListarPecasParaCotacao criada (versão simplificada)';
GO

-- =============================================
-- SP: Resumo da Conversa para Cotação (CORRIGIDA)
-- =============================================
...
BEGIN
    ...
    GROUP BY c.Id, c.NomeCliente, c.DataInicio, c.ModeloId;
...
PRINT '✓ AIHT_sp_ResumoCotacao criada (versão simplificada)';
GO
...
PRINT '';
PRINT '========================================';
PRINT 'Stored Procedures corrigidas!';
PRINT '========================================';
GO
